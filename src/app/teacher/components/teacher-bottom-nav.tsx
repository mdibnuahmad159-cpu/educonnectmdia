...
export function TeacherBottomNav() {
  ...
  const handleScannerResult = async (decodedText: string) => {
    ...
    // Check if it's a Teacher (record self attendance)
    ...
    // Check if it's a Student (record student attendance)
        ...
        <DialogContent className="sm:max-w-md p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Pindai barcode Santri untuk mencatat kehadiran di jam pertama Anda, atau barcode diri sendiri untuk absen harian.
            </DialogDescription>
          </DialogHeader>
          {isScannerOpen && (
            <BarcodeScanner 
