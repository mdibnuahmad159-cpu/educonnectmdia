                        ...
                        <Card className="border-none shadow-sm overflow-hidden">
                            <CardHeader className="py-3 bg-muted/20 border-b">
                                <CardTitle className="text-xs uppercase tracking-widest text-muted-foreground flex items-center gap-2">
                                    <History className="h-3.5 w-3.5" /> Transaksi Tanggal {transactionDate ? format(parseISO(transactionDate), "dd/MM/yy") : "-"}
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="p-0">
                                {loadingTransactions ? (
                                        ...
                                        {historyOnSelectedDate.map((t) => (
                                            <div key={t.id} className="flex items-center justify-between p-4 hover:bg-muted/10 transition-colors">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-[11px] font-bold leading-tight uppercase">{t.saverName}</p>
                                    ...
                                    <div className="py-12 text-center text-muted-foreground/40 flex flex-col items-center">
                                        ...
                                        <p className="text-[10px] italic">Tidak ada transaksi pada tanggal ini.</p>
                                    </div>
                                )}
                            </CardContent>
                        </Card>
