            ...
            <html>
                ...
                <body>
                    ...
                    <div class="meta-info">
                        ...
                        ${(formData.type !== 'undangan' && formData.type !== 'izin' && formData.type !== 'pemberitahuan') ? `<div class="meta-right">Sampang, ${dateFormatted}</div>` : ''}
                    </div>
                    ...
                    <Card className="max-w-[800px] mx-auto border shadow-lg overflow-hidden bg-white">
                        <div className="p-10 text-black text-[11px] leading-tight font-serif min-h-[1050px] flex flex-col relative">
                            ...
                            <div className="flex justify-between mb-6">
                                ...
                                {(formData.type !== 'undangan' && formData.type !== 'izin' && formData.type !== 'pemberitahuan') && (
                                    <div>
