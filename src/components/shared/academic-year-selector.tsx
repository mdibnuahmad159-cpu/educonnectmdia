    ...
    <div className="relative overflow-visible">
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button 
                    variant="secondary" 
                    className="rounded-full bg-secondary/80 hover:bg-secondary text-foreground font-bold px-4 h-9 border-none shadow-sm transition-all flex items-center gap-2 group outline-none"
                >
            ...
            <DropdownMenuContent 
                align="start" 
                sideOffset={8}
                className="w-48 rounded-[24px] p-2 shadow-2xl border-none bg-card z-[100] animate-in fade-in zoom-in-95 duration-200"
            >
                ...
                <DropdownMenuItem 
                    ...
                    className="flex items-center gap-3 p-2.5 rounded-[18px] cursor-pointer focus:bg-muted group transition-all"
                >
                ...
                <DropdownMenuItem 
                    ...
                    className="flex items-center gap-3 p-2.5 rounded-[18px] cursor-pointer focus:bg-primary/5 group"
                >
                    <div className="text-muted-foreground group-hover:text-primary transition-colors">
                        <Plus className="h-4 w-4" />
                    </div>
                    <span className="flex-1 text-xs font-medium text-muted-foreground group-hover:text-primary">
                        Input Manual...
                    </span>
                </DropdownMenuItem>
            </DropdownMenuContent>
            ...
            <DialogContent className="sm:max-w-xs rounded-[28px] p-6">
                ...
                <div className="py-4">
                    <Input 
                        ...
                        className="h-12 rounded-2xl font-mono text-center text-lg tracking-wider"
                    />
                </div>
                <DialogFooter>
                    <Button 
                        onClick={handleManualSubmit} 
                        className="w-full rounded-full h-11 font-bold text-xs uppercase tracking-widest"
